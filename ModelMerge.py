...
#cols = ['technical_30']
cols = ['technical_30', 'technical_20']
train2 = train[cols].copy()

y2 = train.y.copy()

N_timestamps = 450 # how many timestamps that are non-nan for each id
N_corr_cut = 0.25 # min mean correlation coefficient when dropping id's
...
rfr = ExtraTreesRegressor(n_estimators=100, max_depth=4, n_jobs=14, random_state=123, verbose=0)
